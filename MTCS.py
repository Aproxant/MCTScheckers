    ...
    def legal_moves(self,x,y):
        ...
        for move in blind_legal_moves:
            if self.on_board(move):
                ...
                elif self.board[move[0]][move[1]].val !=self.board[x][y].val and self.on_board((move[0] + (move[0] - x), move[1] + (move[1] - y))) and self.board[move[0] + (move[0] - x)][move[1] + (move[1] - y)].val == 0: # is this location filled by an enemy piece?
                    hit=(move[0],move[1])
                    ...
                    while next_hop: 
                        ...
                        for i in self.blind_legal_moves(legal_moves[-1][0][0],legal_moves[-1][0][1]):
                            if i[0]==hit[0] and i[1]==hit[1]:
                                continue
                            if self.board[i[0]][i[1]].val!=0 and self.board[i[0]][i[1]].val !=self.board[legal_moves[-1][0][0]][legal_moves[-1][0][1]].val and self.on_board((i[0] + (i[0] - legal_moves[-1][0][0]), i[1] + (i[1] - legal_moves[-1][0][1]))) and self.board[i[0] + (i[0] - legal_moves[-1][0])][i[1] + (i[1] - legal_moves[-1][1])].val == 0:
                                hit=(i[0],i[1])
                                legal_moves.append(((i[0] + (i[0] - legal_moves[-1][0][0])), i[1] + (i[1] - legal_moves[-1][0][1]),[legal_moves[-1][1],hit]))
                                next_hop=True
